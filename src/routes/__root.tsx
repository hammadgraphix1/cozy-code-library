...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hammad Graphix - Brand Identity & Social Media Design" },
      ...
      { property: "og:title", content: "Hammad Graphix - Brand Identity & Social Media Design" },
      { name: "twitter:title", content: "Hammad Graphix - Brand Identity & Social Media Design" },
