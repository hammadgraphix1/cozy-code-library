    ...
    <div className="bg-[#0A0A0A] text-white">
      ...
      <section className="pt-40 pb-20">
        <div className="mx-auto max-w-[1600px] px-5 sm:px-10">
          <span className="text-[10px] uppercase tracking-[0.3em] text-[#C8FF00]">Services</span>
          <h1 className="mt-4 font-display text-[14vw] sm:text-[10vw] leading-[0.88] tracking-[-0.04em]">
            Built to be<br/><em className="not-italic text-[#C8FF00]">remembered.</em>
          </h1>
      ...
      <section className="pb-32">
        <div className="mx-auto max-w-[1600px] px-5 sm:px-10 space-y-6">
          {services.map((s, i) => (
            <div key={s.title} className="group relative overflow-hidden rounded-3xl border border-white/8 bg-[#111] p-8 sm:p-12 lg:p-16 hover:border-[#C8FF00]/30 transition-colors">
              <div className="pointer-events-none absolute -right-40 -top-40 h-[400px] w-[400px] rounded-full bg-[#C8FF00]/[0.04] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
              <div className="relative grid gap-10 lg:grid-cols-[1fr_2fr] lg:items-start">
                <div className="flex items-center gap-6">
                  ...
                  {s.comingSoon && (
                    <span className="inline-flex items-center gap-2 rounded-full bg-[#C8FF00] text-black px-3 py-1.5 text-[9px] uppercase tracking-[0.22em] font-bold">
                      Coming Soon
                    </span>
                  )}
                </div>
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-10 inline-flex items-center gap-3 rounded-full bg-[#C8FF00] text-black px-7 py-4 text-xs font-bold uppercase tracking-[0.18em] hover:scale-105 transition-transform"
                  >
                    Free Consultation →
                  </a>
                </div>
